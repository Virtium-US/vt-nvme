/**
 * IMPORTANT NOTE TO VIRTIUM DEVELOPERS
 * 
 * This header file is a static copy of nvme.h which is a source file from 
 * the Windows SDK. The only change made to this source file is renaming 
 * NVME_COMMAND, *PNVME_COMMAND to WIN_NVME_COMMAND, *PWIN_NVME_COMMAND 
 * respectively. These changes were made to not conflict with existing 
 * StorKit types. 
 * 
 * source: https://github.com/tpn/winsdk-10
 */ 
...
} WIN_NVME_COMMAND, *PWIN_NVME_COMMAND;
